...
const Solution = ({permission}) => {
  ...
  return (
    <Flexbox direction="column">
      ...
      <ul>
        <li>Check your page. Is there a speed or design issue? Is it broken in some other way?</li>
        <li>It could be the wrong people are coming to your site. It could from targeting the wrong keywords for SEO or PPC, or another problem with your marketing campaign.</li>
